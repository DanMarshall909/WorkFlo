...
public class CommitValidationServiceTests
{
    ...
    [Fact]
    public async Task pre_commit_validation_enforces_file_count_ruleAsync()
    {
        // Arrange
    ...
    [Fact]
    public async Task pre_commit_validation_enforces_branch_ruleAsync()
    {
        // Arrange
    ...
    [Fact]
    public async Task pre_commit_validation_passes_with_valid_conditionsAsync()
    {
        // Arrange
    ...
    [Fact]
    public async Task commit_message_validation_enforces_conventional_formatAsync()
    {
        // Arrange
    ...
    [Fact]
    public async Task commit_message_validation_passes_with_valid_formatAsync()
    {
        // Arrange
