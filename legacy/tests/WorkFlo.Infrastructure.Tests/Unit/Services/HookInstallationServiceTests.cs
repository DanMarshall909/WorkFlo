...
public class HookInstallationServiceTests : IDisposable
{
    ...
    [Fact]
    public async Task hook_installation_fails_outside_git_repositoryAsync()
    {
        // Act
    ...
    [Fact]
    public async Task developer_can_install_hooks_in_git_repositoryAsync()
    {
        // Arrange
    ...
    [Fact]
    public async Task installed_hooks_call_workflo_validate_commandAsync()
    {
        // Arrange
        Directory.CreateDirectory(Path.Combine(_testDirectory, ".git"));
        Directory.CreateDirectory(Path.Combine(_testDirectory, ".git", "hooks"));
    ...
    [Fact]
    public async Task existing_hooks_prevent_installation_without_forceAsync()
    {
        // Arrange
        Directory.CreateDirectory(Path.Combine(_testDirectory, ".git"));
        Directory.CreateDirectory(Path.Combine(_testDirectory, ".git", "hooks"));
    ...
    [Fact]
    public async Task force_flag_overwrites_existing_hooksAsync()
    {
        // Arrange
        Directory.CreateDirectory(Path.Combine(_testDirectory, ".git"));
        Directory.CreateDirectory(Path.Combine(_testDirectory, ".git", "hooks"));
