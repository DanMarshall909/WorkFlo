...
class ConfidenceCalculator {
     ...
     */
    calculateBasicConfidence(testsPassed, estimatedCoverage = 95) {
        const basicResults = {
            testsPassed,
     ...
     */
    validateMutationScore(mutationScore) {
     ...
     */
    shouldAutoMerge(confidenceResult) {
     ...
     */
    generateConfidenceReport(confidenceResult) {
