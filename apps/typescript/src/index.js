...
const showUsage = () => {
  ...
  console.log("Options:");
  console.log(
    "  --persona <name>  Switch to a different AI persona (e.g., claude, gemini)"
  );
  console.log("");
  ...
  console.log(
    "  issue create [title] [description] [labels] [criteria...]  Create GitHub issue"
  );
  console.log(
    "  label create <name> [color] [description]                  Create GitHub label"
  );
  console.log("");
