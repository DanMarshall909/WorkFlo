...
async function updateIssue(issueNumber, acDescription) {
    try {
        ...
        const issueData = (0, child_process_1.execSync)(`gh issue view ${issueNumber} --json body`, { encoding: 'utf-8' });
        ...
        (0, child_process_1.execSync)(`gh issue edit ${issueNumber} --body-file "${tmpFile}"`, { encoding: 'utf-8' });
        return {
            success: true,
