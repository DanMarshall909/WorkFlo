...
echo ""
echo -e "${BLUE}ℹ️  Note:${NC} The scripts now support trunk-based development:"
echo "- Current: master branch (default for trunk-based development)"
echo "- Override: set WORKFLO_MAIN_BRANCH to use a different branch"
echo ""
echo "To use legacy dev branch: export WORKFLO_MAIN_BRANCH=dev"