...
# Comprehensive PR Quality Check Script for Anchor Project (Bash version)
...
print_header "🚀 Starting PR Quality Check for Anchor Project"
...
if command_exists jb; then
    ...
    if $JB_CMD inspectcode Anchor.sln --output="$RESHARPER_OUTPUT_FILE" --format=Xml --severity=WARNING >/dev/null 2>&1; then
...
<html>
<head>
    <title>Anchor PR Quality Report</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>🚀 Anchor PR Quality Report</h1>
...
cat >> "$OUTPUT_PATH" << EOF
        ...
        <div class="footer">
            <p>Generated by Anchor PR Quality Check Script</p>
