    ...
    <AuthGuard requireAuth={false} redirectTo="/tasks">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-6 text-center text-3xl font-bold tracking-tight text-on-background">
          Welcome back to WorkFlo
        </h2>
        <p className="mt-2 text-center text-sm text-on-surface-variant">
          Sign in to your privacy-protected workspace
        </p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-primary-container border border-primary rounded-lg p-4">
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-on-primary-container">Privacy Protected</h3>
              <p className="mt-1 text-xs text-on-primary-container opacity-90">
                Your data is encrypted and stored locally. We never sell or share your information.
              </p>
            </div>
          </div>
        </div>
