...
const switchPersona = (persona) => console.log(`Switching to persona: ${persona}`);
const tdd_start = (issue) => console.log(`Starting TDD for issue: ${issue}`);
...
const flo_feature = (issue) => console.log(`Starting feature development for issue: ${issue}`);
const board_list = () => console.log('Listing board issues');
const board_show = (id) => console.log(`Showing board issue: ${id}`);
const board_create = () => console.log('Creating new board issue');
const github_create_issue = (title, description, labels, criteria) => console.log(`Creating issue: ${title}`);
const github_create_label = (name, color, description) => console.log(`Creating label: ${name}`);
